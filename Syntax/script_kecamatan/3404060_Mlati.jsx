...
function Main() {
	...
	app.changeTextPreferences.changeTo = "Mlati";
	document.changeText();
	...
	// change kokap to Mlati in master page
	for (var i = 0; i < masterPages.length; i++) {
		...
		for (var j = 0; j < allTextFrames.length; j++) {
			...
			// if in textFrame include "Kokap" then change to "Mlati"
			if (textFrame.contents.indexOf("Kokap") !== -1) {
				textFrame.contents = textFrame.contents.replace("Kokap", "Mlati");
			}
		}
	}
