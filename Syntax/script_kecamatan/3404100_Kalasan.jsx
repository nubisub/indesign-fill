...
function Main() {
	...
	app.changeTextPreferences.changeTo = "Kalasan";
	document.changeText();
	...
	// change kokap to Kalasan in master page
	for (var i = 0; i < masterPages.length; i++) {
		...
		for (var j = 0; j < allTextFrames.length; j++) {
			...
			// if in textFrame include "Kokap" then change to "Kalasan"
			if (textFrame.contents.indexOf("Kokap") !== -1) {
				textFrame.contents = textFrame.contents.replace("Kokap", "Kalasan");
			}
		}
	}
